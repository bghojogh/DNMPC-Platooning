function [Xp, Xdes, u, Udes, Xa, Xnfa, Xnffa] = Costfunction1_returnParams(Np, Tim_step, X0, u, Vehicle_Type, Xdes, Xa, Xnfa,Xnffa)
...
%                 (X0(1:2)-Xnfa(1,:))*G*(X0(1:2)-Xnfa(1,:))'+(X0(1:2)-Xnffa(1,:))*G*(X0(1:2)-Xnffa(1,:))';                               % ???????
%     for i = 1:Np-1        %% ?????????? X'Q'QX
